...
| [quelle-beb97](quelle-beb97.md) | BEB 97 des VDZI — Nomenklaturliste für private Laborleistungen, keine Gebührenordnung. Hauptgruppen, Status 2026 gegenüber „BEB Zahntechnik", bekannte Katalogschwächen. Katalog: `kataloge/beb97_zahniAI.json` | 1997, Katalogstand 2026 |
| [quelle-review-vorlagen-2026-08](quelle-review-vorlagen-2026-08.md) | Eigene Auswertung: Prüfung aller 228 Abrechnungsvorlagen und Primärquellenrecherche. 642 Befunde, Belegtypen [Q]/[P]/[E]. Raw: `raw/review-2026-08/` | 04.08.2026 |

### Noch nicht ingestete Quellen

| Quelle | Inhalt und Bedeutung |
|---|---|
| `raw/_inbox/BMP_2026_Leistungen_Regelversorgung.pdf` | „Bundeseinheitliche durchschnittliche Netto-Preise nach § 57 Abs. 2 Satz 1 SGB V für BEL II – 2014, Leistungen für die Regelversorgung", gültig 01.01.–31.12.2026. Liefert die **117 L-Nrn., die die Regelversorgung bilden**, mit ihrem Bundesmittelpreis. Seit drei Ingests offen. Enthält **keine** Befundnummern → die Zuordnung Befund → BEL-Positionen ist daraus nicht zu gewinnen (Prüfung 05.08.2026, s. [[bel-preisbildung-festzuschuss]]) |
| Gemeinsame Rundschreiben des BEL-Ausschusses | Nach § 4/§ 5 verbindliche Quellengattung, ohne eigene Quellenseite im Wiki. Vier Rundschreiben (19.03.2014, 29.02.2016, 18.12.2019, 27.09.2021) und die Gesichtsbogen-Erklärung stehen beim GKV-SV zum Download bereit → [[quelle-bel-ii-2014]] |
...
Die Vollständigkeit der Änderungsvereinbarungen zum BEL II ist am 05.08.2026 geprüft worden:
Der GKV-Spitzenverband führt genau zwei, beide im Wiki abgebildet. Nach dem 01.01.2023 ist keine
weitere hinzugekommen → [[quelle-bel-ii-2014]].
...
| [bel-ii-zusatzkosten-material](bel-ii-zusatzkosten-material.md) | Was neben den Leistungen abrechenbar ist: abschließende Liste des § 2 Ziff. 4, Konfektionsfertigteile gegenüber Hilfsteilen, EM-Legierungen, Lote (75-%-Regel) — und der Umkehrschluss, was abgegolten ist |
| [bel-ii-implantatversorgung](bel-ii-implantatversorgung.md) | Die `___ 8`-Positionen, Nr. 36 a (Einzelzahnlücke) gegenüber Nr. 36 b (atrophierter zahnloser Kiefer), Bestätigungspflicht des Zahnarztes |
...
| [bel-preisbildung-festzuschuss](bel-preisbildung-festzuschuss.md) | Drei Preisarten je L-Nr. (Bundesmittelpreis / regionale Vergütung / `bel.json`) — welche in den KV gehört; § 57 Abs. 2 SGB V, 5-%-Korridor, Kopplung an die FZ-Richtlinie |
...
| [festzuschuss-haertefall-bonus](festzuschuss-haertefall-bonus.md) | 60/70/75/100 %, Bonusheft, die unterschiedliche Härtefallwirkung bei Regelversorgung gegenüber gleich-/andersartig, Rechenweg für den Eigenanteil |
...
| Seite | Inhalt |
|---|---|
| [beb97-grundlagen](beb97-grundlagen.md) | Preisbildung über Planzeit × Kostensatz, Hauptgruppen als Abrechnungsinhalt, Komplettposition gegenüber Einzelschritten, BEL/BEB nicht mischen |
...
| Seite | Inhalt |
|---|---|
| [bel-ausschlussregeln](bel-ausschlussregeln.md) | Alle „nicht nebeneinander / nur wenn / stattdessen"-Regeln: gegenseitige Ausschlüsse, Grundeinheit gegenüber Unterfütterung, Artikulator-Verbote, Umleitungsregeln, Praxis-/Gewerbelabor |
...
- `kataloge/bel.json` — 175 L-Nrn. in 9 Komplexen, Preise (Gewerbelabor / Praxislabor).
  ...
  Preisstruktur und Abstand zum Bundesmittelpreis: [[bel-preisbildung-festzuschuss]].
  Der Katalog führt bei 933 0/5/8 auch einen Praxislabor-Preis, obwohl Versandkosten im
...
- `vorlagen/` — 228 Abrechnungsvorlagen je Konfigurator-Bereich, Schema:
  ...
  `# Material` · `# Hinweise`
- `raw/review-2026-08/findings_register.json` — die 642 Einzelbefunde. Beim Zählen beachten: das
