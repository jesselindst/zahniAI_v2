...
### Zwei Zählweisen, die nicht zu vermischen sind
...
Beide Zahlen sind richtig. Weitere Paare: Positionen 198 Befunde / 190 Vorlagen · Härtefall 27 /
137 · Material 54 / 114. Wer sie nebeneinanderstellt, muss die Einheit dazusagen — sonst wirkt
...
## 1. Falsche, unzulässige und doppelte Positionen (198 Befunde / 190 Vorlagen)

Das ist die größte Kategorie des Registers (`kategorie = positionen`). Sie umfasst die
Abschnitte 1 und 2 dieser Seite gemeinsam; die 198 Befunde sind also nicht allein
Doppelabrechnungen. Die Doppelabrechnung ist darin der häufigste Einzelfall.
...
Gehört ebenfalls zur Kategorie `positionen` (siehe oben).
...
| BEL 0023 für Stümpfe/CAD-CAM-Stumpfmodelle | — | seit 01.01.2023 ausdrücklich ausgeschlossen; mindestens 18 Vorlagen |
...
| Modellguss mit 2.7 | 3.1 je Kiefer (belegt über das `regelversorgung`-Array: 3.1 enthält BEL 2010 Metallbasis, 2.7 nicht — Katalog liegt nicht im Repo, siehe [[festzuschuss-befundklassen-referenz]]) |
...
- Der gefräste oder individuelle Weg beim Sekundärteil (3301/3221/3321) fehlte, obwohl der
...
daraus Regeln ab, etwa ein „Mengen-Limit: max. 3 Teleskope", das es nicht gibt.

Merkregel: Eine Regel ohne auffindbare Fundstelle ist keine Regel. Im Zweifel als
VERIFIZIEREN markieren, statt plausibel klingend zu behaupten.
...
- BEL 9330 je Versandgang: ein Hin- und Rückweg ist ein Gang, keine getrennte
  Hin-/Rückberechnung; Leerfahrten zählen nicht; nur Gewerbelabor.
  Nur mittelbar belegt (gRS 11.07.2016, Volltext nicht zugänglich); der Leerfahrten-Teil ist
  reine Portalquelle → Herleitung und Vorbehalt in [[bel-gruppe-zuschlaege-versand]].
  **VERIFIZIEREN**
- BEL 002 3 seit 01.01.2023: Bezugsgröße je aufgefülltem Sekundärteil, höchstens 3× je Modell

→ [[bel-mengenregeln]]

## 9. Struktur- und Konsistenzfehler

- Dieselbe Nummer in Basis- und Zusatzleistungen derselben Vorlage (unter anderem 0701 in
  12 Vorlagen)
