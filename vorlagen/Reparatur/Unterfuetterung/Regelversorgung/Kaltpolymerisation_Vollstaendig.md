...
|--------|--------|--------|--------|
| 0010 | Modell | 1 | Gegenbiss-/Konter-/Unterfütterungsmodell (BEL II 001 0 explizit für Unterfütterung); je Kontrollmodell zusätzlich abrechenbar |
...
| 8090 | Vollständige Unterfütterung | 1 | je Prothese (bei bimaxillär: je Kiefer); Standardposition Kaltpolymerisat |
...
| 8100 | Prothesenbasis erneuern | 1 | alternativ zu 8090 bei vollständigem Austausch der Kunststoffbasis |
| 8108 | Prothesenbasis erneuern/Implantatversorgung | 1 | alternativ zu 8100 bei implantatgestützter Prothese |
...
|--------|--------|--------|
| PMMA-Kaltpolymerisat (Autopolymerisat) | — | Standard-Verfahren, schneller |
...
Vollständige Unterfütterung mit Kaltpolymerisat — Regelversorgung. Standard-Verfahren bei kurzfristigem Bedarf, schneller als Heißpolymerisation aber etwas kürzere Lebensdauer.
...
- BEL **8010 (Grundeinheit ZE) ist KEINE eigenständige Leistung** zur Unterfütterung — nur abrechenbar, wenn zusätzlich eine Instandsetzung erbracht wird.
- BEL 3822 (Sonderkunststoff) nur bei zahnärztlicher Indikationsstellung; je Prothese 1×.
- BEL 0023 (Verwendung von Kunststoff) max. 3× pro Fall.
- BEL 0212 (Funktionslöffel) nur bei zahnlosem Kiefer oder ≤3 Restzähnen; sonst BEL 0211.
