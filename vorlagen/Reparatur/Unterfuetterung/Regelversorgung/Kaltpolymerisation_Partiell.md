...
| 8080 | Teilunterfütterung einer Basis | 1 | je Prothese (auch bei mehreren Bereichen nur 1×); lokale Anpassung |
| 8088 | Teilunterfütterung/implantatgest. | 1 | alternativ zu 8080 bei implantatgestützter Basis |
| 8085 | Teilunterfütterung einer Basis UKPS | 1 | alternativ zu 8080 bei UKPS |
...
|--------|--------|--------|
| PMMA-Kaltpolymerisat (Autopolymerisat) | — | Standard-Verfahren |
| Modellgips (Hartgips) | — | für Modell und Konter |
| Desinfektionsmittel | — | nach Herstelleranweisung |

# Hinweise

Partielle Unterfütterung mit Kaltpolymerisat — Regelversorgung. Schnelle, kostengünstige Anpassung lokaler Druckstellen.

**Festzuschuss:** Befund **6.6** "Verändertes Prothesenlager bei erhaltungswürdigem Teil-Zahnersatz, je Prothese" (FZ-RL 2024-11-21) bzw. **6.7** bei Total-/Deckprothese. Beide Befunde listen 8080/8090/8100 + 3821/3822 + 0010/0112/9330 explizit unter `regelversorgung_zahntechnik`.

**BEL-Regeln (kritisch):**
- BEL 808 0 ist je Prothese / je Kiefer **nur 1×** abrechenbar — selbst bei mehreren unterfütterten Bereichen.
- **Fixator (0112) ist** bei Unterfütterung **abrechenbar**, **Artikulator (012 0/5/8) NICHT** (BEL II §5 + Erläuterungen zu 808 0).
- BEL **8010 (Grundeinheit ZE) ist KEINE eigenständige Leistung** zur Unterfütterung — nur abrechenbar bei zusätzlicher Instandsetzung.
...
- Bei UKPS: BEL 0015 / 0115 / 8085 statt 0010 / 0112 / 8080.