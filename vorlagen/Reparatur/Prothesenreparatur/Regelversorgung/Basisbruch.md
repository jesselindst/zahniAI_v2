...
- Versorgungsform: Regelversorgung (Wiederherstellung) — für die Einstufung ist die Art des vorhandenen Zahnersatzes NICHT maßgeblich (FZ-RL Abschnitt 6, Protokollnotiz); auch der Bruch einer privat gefertigten Prothese ist beim GKV-Versicherten Regelversorgung
...
| 8010 | Grundeinheit ZE | 1 | einmal je Prothese; nur zusammen mit einer Leistungseinheit (hier 8022) |
| 8022 | LE Bruch | je Bruchstelle | nicht miteinander verbundene Brüche entsprechend mehrfach; nachträglich entdeckte Brüche nur nach Rücksprache mit der Praxis |
...
| 8024 | LE Basisteil Kunststoff | je Basisteil | bei zusätzlich erneuertem Kunststoff-Basisteil; nur wenn an derselben Stelle keine andere Leistung erbracht wird |
...
| 8070 | Metallverbindung bei Instandsetzung/Erweiterung | je Metallverbindung | nur bei Bruch in der Metallbasis; nicht neben 8030/8040/8060; löst Befund 6.3 aus |
...
- → Vorlage Riss-Sprung bei Sprung ohne vollständige Trennung; → Vorlage Zahnbruch bei Konfektionszahn-Erneuerung; → Vorlage ../../Erweiterung/ bei Befundveränderung (Erweiterung um Zähne, FZ 6.4/6.5); → Vorlage ../Privatleistung/Basisbruch nur bei PKV, Selbstzahler ohne HKP oder ausdrücklichem Komplett-Privatwunsch
...
- Im Leistungspreis enthalten (§ 2 Nr. 4 BEL II): Modellgips (Hartgips), Superhartgips, PMMA-Reparaturkunststoff (Kaltpolymerisat), Heißpolymerisat, Klebehilfe/Reparatur-Anker, Trenn- und Poliermittel, sonstiges Verbrauchsmaterial Praxis
