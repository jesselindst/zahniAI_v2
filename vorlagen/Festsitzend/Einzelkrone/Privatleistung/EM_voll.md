...
EM-Krone mit gegossenem Edelmetall-Gerüst und keramischer Vollverblendung als reine Privatleistung — Patient ist PKV-versichert oder GKV-Patient mit Wunsch nach komplett-privater Abrechnung (kein HKP, kein Festzuschuss-Antrag). Komplette Abrechnung über BEB97 ohne BEL-Anteil. Im Gegensatz zur gleichartigen Variante entfällt die Festzuschuss-Bezuschussung der GKV vollständig; gesamte Krone wird privat abgerechnet. Bei NEM-Gerüst statt hochgoldhaltiger/goldreduzierter Legierung ändern sich die Krone-Position zu 2122 (NEM gegossen) ohne 2982 (Sonderlegierung) und stattdessen 2981 (NEM Zuschlag). Bei CAD-CAM gefräst statt gegossen kommt 2162 zum Einsatz.
