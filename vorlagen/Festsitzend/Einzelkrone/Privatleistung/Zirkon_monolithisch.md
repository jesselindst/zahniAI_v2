...
| 2874 | Zirkonkrone, vollanatomisch | je Krone | monolithische Zirkonkrone, Konstruktionsschritt der modularen Kette |
...
| 2689 | Farbgebung durch Bemalen | je Krone | monolithisch: Bemalung statt Schichtkeramik |
...
| 0917 | Konstruktion CAD-Krone zur Verblendung | je Krone | nur bei Cut-back/Verblendung, nicht bei monolithischer Ausführung |
| 2876 | Zirkonoxidkrone, individuell verblendet | je Krone | statt 2874 bei individueller Verblendung |
| 2826 | CAD/CAM-Krone aus Keramik (vollanatomisch) | je Krone | alternativ zu 2874 bei anderer Vollkeramik |
...
| 2952 | Zuschlag bei Verarbeitung von Spezialkeramik | je Krone | bei hochtransluzentem/Multilayer-Zirkon |
...
|--------|--------|--------|
| Zirkon-Blank | 1 Stück | gesondert im Privatanteil: Einkaufspreis/Blankanteil, Beleg beifügen; Typ (z. B. hochtransluzent multilayer) in der Bemerkung der Rechnung |

# Hinweise

- Scan-/CAD-Kette: entweder 0891 + 0918 (ggf. mit 0825/0827) ODER die Sammelposition 0840 bzw. 2160 — nie additiv nebeneinander
- 2874 + 2823 + 2832 sind hier als modulare Kette (Konstruktion / Fertigung / Ausarbeitung) angesetzt; 0917 entfällt bei monolithischer Ausführung
...
- → Vorlage Zirkon_voll bei Schichtkeramik-Vollverblendung; → ../gleichartig/Zirkon_monolithisch bei GKV-Patient mit HKP (dann gleichartig mit FZ 1.1, +1.3 im Verblendbereich OK 15-25/UK 34-44) — diese Vorlage nur für PKV bzw. Komplett-Privat ohne HKP
- Im Leistungspreis enthalten: Bemalkeramik/Malfarben, Glasurmasse, Sinterhilfsmittel (Sinterperlen/-schale), Modellgips (Hartgips), Superhartgips (Stumpfmaterial), Stumpf-Kunststoff, Isolier-/Trennmittel
- VERIFIZIEREN: BEB-Hausliste — ob 2874 als Komplettposition kalkuliert ist (dann 2823/2832 aus der Basis streichen); Hauslogik des Modellblocks (0021/0002/0103/0117), 0007 nur bei tatsächlichem Kontrollmodell
