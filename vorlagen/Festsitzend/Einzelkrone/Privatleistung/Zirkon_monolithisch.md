...
| 2874 | Zirkonkrone, vollanatomisch | 1 | je Krone, monolithische Zirkon-Krone |
...
| 2689 | Farbgebung durch Bemalung auf Fräskeramik | 1 | je Krone, Bemalung/Charakterisierung |
...
| BEB97 | Leistung | Menge | Bemerkung |
|--------|--------|--------|--------|
| 2876 | Zirkonoxidkrone, individuell verblendet | 1 | alternativ zu 2874 bei individueller Verblendung |
| 2826 | CAD/CAM-Krone aus Keramik (vollanatomisch) | 1 | alternativ zu 2874 (allgemeine Vollkeramik-Pos) |
...
| 2951 | Individuell charakterisieren, Keramik | 1 | je Krone, bei intensiver Charakterisierung |
| 2952 | Zuschlag bei Verarbeitung von Spezialkeramik | 1 | bei Spezialkeramik (transluzentes Zirkon) |
...
| 0840 | Scannen, CAD-Konstruktion Krone | 1 | alternativ zu 0891/0918-Kette |
| 0907 | Digitaler Datenversand | 1 | bei STL-/Daten-Versand |
| 0908 | Empfang/Aufbereitung Mundscandaten | 1 | bei Intraoralscan-Empfang |
| 0917 | Konstruktion CAD-Krone zur Verblendung | 1 | bei zusätzlicher Verblend-Konstruktion |
...
|--------|--------|--------|
| CAD/CAM Block Zirkon (translucent multilayer) | 1 Stück | je Krone, Zirkonoxid-Block für monolithische Krone |
| Bemalkeramik / Mal-Farben | — | für Farbgebung und Charakterisierung |
| Glasur | — | für Hochglanz-Brand |
...
CAD-CAM gefräste monolithische Zirkon-Vollkrone (ohne Schichtkeramik-Verblendung) als reine Privatleistung — Patient ist PKV-versichert oder wünscht komplette Privatabrechnung. Komplette Abrechnung über BEB97 ohne BEL-Anteil und ohne Festzuschuss-Antrag. Monolithisches Zirkon (translucent multilayer) bietet hohe Stabilität bei Bruxismus und Molarenbereich; nur Bemalung und Glasur, keine Schichtkeramik. Bei Schichtkeramik-Vollverblendung wechselt die Vorlage zu `Zirkon_voll.md`. Im Gegensatz zur gleichartigen Variante entfällt der GKV-Festzuschuss komplett.