...
VMK-Krone mit gegossenem NEM-Gerüst und keramischer Vollverblendung als reine Privatleistung — Patient ist PKV-versichert oder wünscht komplette Privatabrechnung. Komplette Abrechnung über BEB97 ohne BEL-Anteil und ohne Festzuschuss-Antrag. Im Gegensatz zur gleichartigen Variante entfällt der GKV-Festzuschuss komplett. Wird das Gerüst CAD-CAM gefräst, kommt 2162 (Krone gefräst, Vollverblendung) zum Einsatz. Bei EM-Gerüst statt NEM wechselt die Vorlage zu `VMK-EM_voll.md`.