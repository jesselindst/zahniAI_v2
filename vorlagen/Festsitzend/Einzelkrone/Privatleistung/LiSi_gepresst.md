...
| 2251 | Krone aus Presskeramik | 1 | je Krone, monolithisch gepresst (Lithium-Disilikat) |
| 2689 | Farbgebung durch Bemalung auf Fräskeramik | 1 | je Krone, individuelle Bemalung/Charakterisierung |
...
| BEB97 | Leistung | Menge | Bemerkung |
|--------|--------|--------|--------|
| 2252 | Krone aus Presskeramik, zur Keramikverblendung | 1 | alternativ zu 2251 bei zusätzlicher Schichtkeramik (Cut-back) |
...
| 2675 | Schulter aus Keramik/Glas | 1 | bei Keramikschulter Front-/Sichtbereich |
...
|--------|--------|--------|
| Presskeramik-Rohling Lithium-Disilikat (E.max Press) | 1 Stück | je Krone, Press-Rohling |
| Einbettmasse (Press-spezifisch) | — | für Pressvorgang |
| Modellgips (Hartgips) | — | Arbeitsmodell + Gegenkiefermodell |
| Stumpfmaterial (Superhartgips) | — | Sägemodell |
| Bemalkeramik / Glasur | — | für Farbgebung und Hochglanz-Brand |

# Hinweise

LiSi gepresst (Press-Technik mit Lithium-Disilikat) als monolithische Vollkrone und reine Privatleistung — Patient ist PKV-versichert oder wünscht komplett-privater Abrechnung. Komplette Abrechnung über BEB97 ohne BEL-Anteil und ohne Festzuschuss-Antrag. Im Gegensatz zur CAD-CAM-Variante wird die Krone gepresst statt gefräst (analoge Technik mit Press-Ofen, Wax-Up-Modellation). Indikation: Frontzahnbereich, Prämolaren, sehr ästhetische Anforderungen. Bei zusätzlicher Schichtkeramik-Verblendung wechselt die Vorlage zu `LiSi_voll.md`.