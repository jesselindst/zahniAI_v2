...
- Versorgungsform: gleichartig (CAD-CAM-gefrästes Zirkon-Gerüst + keramische Vollverblendung = Mehrleistung; die BEL-Kronenpositionen 102x setzen Gusstechnik voraus)
...
| 2810 | CAD/CAM-Krone, vollständig verblendet | je Krone | Komplettposition inkl. Verblendung — nicht neben 2612; bei Frontzahn alternativ 2807 |
| 2823 | CAD/CAM-Fräsen/-Schleifen einer CAD/CAM-Einheit | je Krone | modulare Fertigungskette |
...
| 2807 | CAD/CAM Frontzahnkrone, vollständig verblendet | je Krone | alternativ zu 2810 bei Frontzahn |
| 2829 | CAD/CAM-Seitenzahnkrone, für keramische Vollverblendung | je Krone | alternativ zu 2810: Gerüstposition + 2612 statt Komplettposition |
| 2612 | Mehrflächige Verblendung aus Keramik | je Krone | nur zur Gerüstposition 2829; nie neben 2810/2807 (sonst Verblendung doppelt) |
| 2876 | Zirkonoxidkrone, individuell verblendet | je Krone | alternativ zu 2810 bei individueller Verblendung des Zirkon-Gerüsts |
| 2826 | CAD/CAM-Krone aus Keramik (vollanatomisch) | je Krone | bei monolithischer Ausführung, alternativ zu 2810; 2612 entfällt → Vorlage Zirkon_monolithisch |
...
| 2611 | Teilverblendung aus Keramik | je Krone | alternativ zu 2612 bei Teilverblendung/Cut-back, nur zur Gerüstposition 2829 |
...
| 2952 | Zuschlag bei Verarbeitung von Spezialkeramik | je Krone | bei transluzentem Zirkon/Spezialkeramik, nach Aufwand |
...
- Entweder Komplettposition 2810 (bzw. 2807 Frontzahn, hier gesetzt) ODER Gerüstposition 2829 + 2612 — nie beides, sonst wird die Verblendung doppelt berechnet; genau EINE Scan-/CAD-Kette (hier 0891 + 0918 + 0917), die Alternativen 0840, 2160, 0825/0827 und 2839/2842/2870 nur als Ersatz, nie additiv
...
- Im Leistungspreis enthalten: Verblendkeramik, Sintermasse/Sinterhilfsmittel, Modellgips (Hartgips), Superhartgips (Stumpfmaterial), Stumpf-Kunststoff, Dubliermasse, Wachs
- → Vorlage Zirkon_monolithisch bei vollanatomischer Ausführung ohne Schichtkeramik; → Vorlage LiSi_voll bei LiSi- statt Zirkon-Gerüst; → Vorlage ../Privatleistung/Zirkon_voll bei PKV/Selbstzahler ohne HKP
