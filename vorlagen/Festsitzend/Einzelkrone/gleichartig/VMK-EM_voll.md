...
|--------|--------|--------|--------|
| 2122 | Krone gegossen, für Keramik- oder Polymer-Glas-Vollverblendung | 1 | je Krone, EM-Gerüst gegossen (Stufenpräparation: 2124) |
...
| 2801 | Kaufläche nach gnathologischen Kriterien (Metall) | 1 | bei Metallgerüst gnathologisch |
...
|--------|--------|--------|
| hochgoldhaltige/goldreduzierte Legierung | ca. 4-6 g | je Krone, für gegossenes EM-Gerüst |
...
VMK-Krone mit gegossenem EM-Gerüst (Edelmetall) und keramischer Vollverblendung ist gleichartige Versorgung — sowohl die Verarbeitung der hochgoldhaltigen/goldrduzierten Legierung als auch die Vollverblendung gehen über die GKV-Regelleistung hinaus. Festzuschuss nach Befundklasse 1.1 in Höhe der Regelversorgung (NEM vestibulär verblendet); Mehrkosten Legierung und Vollverblendung trägt der Patient. Bei NEM-Gerüst statt EM wechselt die Vorlage zu `VMK-NEM_voll.md`. Wird das Gerüst CAD-CAM gefräst, kommt 2162 (Krone gefräst, Vollverblendung) zum Einsatz.
