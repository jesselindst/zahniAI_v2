...
| 2982 | Sonderlegierung verarbeiten | je Krone | Zuschlag für nicht betriebsübliche (EM-)Legierung, nach Aufwand |
...
|---|---|---|
| EM-Legierung hochgoldhaltig (Au ≥ 60 %), <Handelsname> | 4–6 g | gesondert: verarbeitetes Gewicht × Tagespreis (€/g) am Verarbeitungstag; Bezeichnung, Gewicht und Tagespreis auf der Rechnung ausweisen (§10 Abs. 2 Nr. 5 GOZ / §2 Nr. 4 BEL II); Gewichtsspanne nur Kalkulationsanhalt |
| EM-Legierung goldreduziert, <Handelsname> | 4–6 g | alternativ zur hochgoldhaltigen Legierung — nie beide; gleiche Nachweispflicht (Bezeichnung, Gewicht, Tagespreis) |
...
- Aus dem BEL-Teil entfallen: 1024 (Krone für vestibuläre Verblendung) und 1620 (Vestibuläre Verblendung Keramik) — eine vollständig verblendete Krone erfüllt den Leistungsinhalt der 1024 nicht und 1620 ist für Vollverblendungen ausdrücklich nicht abrechenbar; sonst stünde dieselbe Krone doppelt (BEL 1024/1620 UND BEB 2122/2612). Gerüst und Verblendung laufen vollständig über BEB. BEL 9700 ist bei EM-Gerüsten nie ansetzbar (nur NEM)
- Entfallen: BEB 0731 (Namenskennzeichnung nur bei herausnehmbarem ZE/KFO-Gerät, nicht bei festsitzendem ZE); „Okklusaler Stop" ist 2915, nicht 2815 (= CAD/CAM-Brückenglied, vollständig verblendet). Im Leistungspreis enthalten: Verblendkeramik, Einbettmasse, Modellgips (Hartgips), Stumpfmaterial (Superhartgips), Dubliermasse, Wachs, Konditionierer/Bonder
- EM statt NEM: die Kasse trägt die EM-Mehrkosten nicht; der BEL-Anteil wird über NEM-Verrechnungseinheiten der jeweiligen KZV angerechnet (Beträge regional, jährlich angepasst) — VERIFIZIEREN: zuständige KZV-Regelung und anzusetzende Einheitenzahl
- → Vorlage ../Regelversorgung/NEM_vestibulaer bei NEM-Gerüst mit rein vestibulärer Verblendung innerhalb VG; → Vorlage VMK-NEM_voll bei NEM- statt EM-Gerüst; → Vorlage ../Privatleistung/VMK-EM_voll bei PKV/Selbstzahler ohne HKP
