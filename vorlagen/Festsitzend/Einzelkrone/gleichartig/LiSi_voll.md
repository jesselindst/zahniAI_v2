...
# Festzuschuss
- Befund: 1.1 je erhaltungswürdigem Zahn mit Kronenbedarf; +1.3 je vestibulärer Verblendung innerhalb VG (OK 15–25 / UK 34–44) — der FZ folgt dem Befund, nicht der gewählten Ausführung: 1.3 fällt auch bei vollverblendeter Vollkeramik an, außerhalb VG dagegen nicht
- Versorgungsform: gleichartig (CAD-CAM-gefrästes LiSi-Gerüst + keramische Vollverblendung = Mehrleistung; die BEL-Kronenpositionen 102x setzen Gusstechnik voraus)
...
| 2162 | Krone gefräst, für Keramik- oder Polymer-Glas-Vollverblendung | je Krone | LiSi-Gerüst gefräst, zur Vollverblendung; alternativ zu 2161 (Teilverblendung) |
| 2823 | CAD/CAM-Fräsen/-Schleifen einer CAD/CAM-Einheit | je Krone | modulare Fertigungskette; nicht neben den Komplettpositionen 2807/2810 |
| 2832 | CAD/CAM Krone/Brückenglied nacharbeiten | je Krone | modulare Fertigungskette |
| 2612 | Mehrflächige Verblendung aus Keramik | je Krone | einmal je Zahneinheit; Verblendung zur Gerüstposition 2162 |
...
| 0104 | Stumpf aus Superhartgips | je Stumpf | nur zusammen mit 0021/0023; alternativ 0117 |
| 0117 | Kunststoffstumpf festsitzend | je Stumpf | statt 0104 bei gefrästem/gedrucktem Stumpf — der Kunststoffstumpf löst im BEL keine Leistung aus |
...
| 2160 | Scannen und konstruieren Zirkon/E-Max-Krone | je Krone | alternativ zur Kette 0891 + 0918 + 0917 |
| 0840 | Scannen, CAD-Konstruktion Krone/Brückenglied | je Krone | alternativ zur Kette 0891 + 0918 + 0917 — nie zusätzlich |
...
| 2839 | Einzelzahn einscannen, Scan prüfen | je Zahn | alternativ zu 0891 bei Einzelzahn-/Intraoralscan |
| 2842 | Frontzahn einscannen (Krone/Brücke) | je Zahn | alternativ zu 0891 bei Frontzahnscan |
| 2870 | Seitenzahn einscannen (Krone/Brücke) | je Zahn | alternativ zu 0891 bei Seitenzahnscan |
...
| 0907 | Digitaler Datenversand | je Datenversand | bei STL-/Datenversand statt Modellversand |
...
| 2813 | CAD/CAM Zirkon anpassen, je Zahneinheit | je Zahneinheit | bei Mehraufwand Anpassung der gefrästen Einheit |
| 2611 | Teilverblendung aus Keramik | je Krone | alternativ zu 2612, nur zusammen mit 2161 |
...
| 0953 | Zahnfarbenbestimmung – Stumpffarbe (III/IV) | 1 | bei transluzenter Vollkeramik |
...
|---|---|---|
| LiSi-Blank (CAD-CAM, z. B. IPS e.max CAD) | 1 Stück | gesondert nur im privaten BEB-Anteil (Kalkulationsfreiheit, Einkaufspreis zzgl. Beleg); im BEL-Anteil abgegolten (§2 Nr. 4 BEL II) |
...
- Entweder modular (2162 + 2612, ggf. + 2823/2832) ODER Komplettposition (2807/2810) — nie beides; 2612 nie neben 2611/2616; genau EINE Scan-/CAD-Kette (hier 0891 + 0918 + 0917), die Alternativen 0840, 2160, 0825/0827 und 2839/2842/2870 nur als Ersatz, nie additiv
- Entfallen: BEB 0731 (Namenskennzeichnung nur bei herausnehmbarem ZE/KFO-Gerät, nicht bei festsitzendem ZE); BEL 0023 nicht mehr als fixe Position „je Stumpfmodell für CAD-CAM" — der Kunststoffstumpf löst im BEL keine Leistung aus (CAD-CAM-Stumpf über BEB 0117), 0023 nur noch für Zahnfleischmaske/Primärteil-Darstellung; „Okklusaler Stop" ist 2915, nicht 2815 (= CAD/CAM-Brückenglied, vollständig verblendet)
- Im Leistungspreis enthalten: Verblendkeramik, Kristallisations-Ofenbedarf, Modellgips (Hartgips), Superhartgips (Stumpfmaterial), Stumpf-Kunststoff, Dubliermasse, Wachs
- VERIFIZIEREN: (a) Gerüstposition für ein gefrästes LiSi-Gerüst — 2162 beschreibt im Katalogtext ein Metallgerüst, 2829 die keramische Vollverblendungs-Gerüstposition; (b) ob 2823/2832 in der Hausliste neben 2162 modular kalkuliert oder darin enthalten sind. → Vorlage LiSi_gepresst bei gepresster statt gefräster Fertigung; → Vorlage Zirkon_voll bei Zirkon-Gerüst; → Vorlage ../Privatleistung/LiSi_voll bei PKV/Selbstzahler ohne HKP
