...
| 2161 | Krone gefräst, für Keramik- oder Polymer-Glas-Teilverblendung | 1 | je Krone, LiSi-Gerüst gefräst (alternativ 2162 Vollverblendung) |
...
| BEB97 | Leistung | Menge | Bemerkung |
|--------|--------|--------|--------|
| 2162 | Krone gefräst, für Keramik-/Polymer-Glas-Vollverblendung | 1 | alternativ zu 2161 bei reiner Vollverblendung |
...
| 2810 | CAD/CAM-Krone, vollständig verblendet | 1 | alternativ zu 2161+2612 als Kombi-Pos |
...
| 2951 | Individuell charakterisieren, Keramik | 1 | je Krone |
...
|--------|--------|--------|
| CAD/CAM Block Lithium-Disilikat (E.max) | 1 Stück | je Krone, LiSi-Block für Fräsung |
...
| Kristallisations-Ofen-Bedarf | — | LiSi Kristallisations-Brand |

# Hinweise

CAD-CAM gefräste Lithium-Disilikat (E.max) Krone mit Schichtkeramik-Vollverblendung ist gleichartige Versorgung — gilt unabhängig von der Position. Begründung: BEL II 2014 stellt klar, dass CAD-CAM gefräste Kronen IMMER gleichartig sind. LiSi bietet hervorragende Ästhetik und Festigkeit, ideal für Frontzahnbereich. BEL deckt Modelle, Artikulator und Versand ab; die LiSi-Krone selbst und der CAD-CAM-Prozess werden über BEB97 abgerechnet. Patient erhält Festzuschuss in Höhe Regelversorgung (Befund 1.1) und trägt die Mehrkosten privat. Bei monolithischer LiSi-Ausführung (ohne Verblendung) wechselt die Vorlage zu `LiSi_gepresst.md` (gepresst) oder als CAD-CAM monolithisch nutzt 2826 statt 2161+2612.