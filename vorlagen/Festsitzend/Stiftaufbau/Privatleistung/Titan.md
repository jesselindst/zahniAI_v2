...
| 2003 | Stiftaufbau indirekt | je Stift | Kernleistung, einmal je Stift; indirekter Aufbau auf konfektioniertem Titanstift |
...
| 0116 | Zweitstumpf aus Metall | je Stumpf | bei metallischem Zweitstumpf |
...
| 0221 | Hilfsteil in Abdruck | je Hilfsteil | bei im Abdruck übertragenem Titanstift |
| 0241 | Dublieren eines Modells oder Modellteils | je Doubliervorgang | resultierendes Modell zusätzlich berechnen |
| 0243 | Dublieren eines Einzelstumpfes | je Stumpf | resultierender Zweitstumpf zusätzlich (0114/0115/0116) |
...
|--------|--------|--------|
| Titanstift (konfektioniert, Reintitan Grad 4) | 1 Stück | je Stift; Konfektionsfertigteil, gesondert: Einkaufspreis zzgl. Beleg; nur berechnen, wenn vom Labor gestellt |

# Hinweise

- Komplett privat (BEB/GOZ, freie Preise), kein Festzuschuss — gilt NUR bei PKV, ohne HKP oder ausdrücklichem Komplett-Privatwunsch. Der Titanstift ist konfektioniert UND metallisch und erfüllt damit den Regelversorgungsinhalt des Befunds 1.4: bei GKV-Patient mit HKP besteht Festzuschussanspruch (Versorgung mindestens gleichartig) → Vorlage ../gleichartig/Glasfaser sinngemäß
- BEB 1050 „Stiftaufbau" (HG1, gegossene Technik) nicht neben 2003 ansetzen — die Kernleistung ist nur einmal je Stift berechenbar; 1050/2003/2051/2052 sind Alternativen
