...
| 1050 | Stiftaufbau | 1 | je Stift, BEB-Position Stiftaufbau |
| 2003 | Stiftaufbau indirekt | 1 | je Stift, indirekte Laboraufbau-Technik auf Carbonstift |
...
| 0216 | Stumpf vorbereiten | je | bei Stumpfvorbereitung für Stift |
| 0221 | Hilfsteil in Abdruck | je | bei konfektioniertem Stift im Abdruck |
...
|--------|--------|--------|
| Carbonstift (konfektioniert) | 1 Stück | je Stift, kohlefaserverstärkter Stift |
| Aufbaukomposit | — | je Stift, für Stumpfaufbau |
| Modellgips (Hartgips) | — | Gegenkiefermodell |
| Stumpfmaterial (Superhartgips) | — | Arbeitsmodell + Sägemodell |
| Bonder / Adhäsiv | — | für Haftung Stift ↔ Wurzelkanal und Stift ↔ Komposit |

# Hinweise

Carbonstift (kohlefaserverstärkter Stift) ist Privatleistung — Patient ohne HKP oder mit explizitem Privatwunsch. Komplett-Privat über GOZ + BEB97. Vorteile Carbon: Elastizitätsmodul nahe Dentin (geringeres Wurzelfrakturrisiko), metallfrei, korrosionsbeständig, leicht entfernbar bei Revision. Nachteile: dunkle Eigenfarbe (kann unter dünnen Vollkeramikkronen durchschimmern, daher meist ungeeignet im sichtbaren Frontzahnbereich), seltener gegenüber Glasfaser. Indikation: Seitenzahnbereich, Patient mit Metallallergie und Anspruch an dentinähnliches Verhalten. Eingliederung adhäsiv mit Bonding-System.