...
| 7606 | Medikamententrägerschiene | je Kiefer | Bleichschiene aus Folie tiefgezogen, eng anliegend, Schienenränder auf der Gingiva |
...
| BEB97 | Leistung | Menge | Bemerkung |
|--------|--------|--------|--------|
| 0303 | Modell ausblocken | je Zahn oder Kieferteil | nur für das Beseitigen untersichgehender Stellen am Modell |
...
- 0721/0722 nur für Arbeitsschritte ohne eigene BEB-Position, je 15 Min nach tatsächlichem Aufwand — nicht neben ausgewiesenen Einzelleistungen desselben Arbeitsschritts
...
- → Vorlage ./mit-Reservoir bei Gel-Reservoir durch Block-Out auf den Zahnflächen (dann zusätzlich 0722 nach Aufwand)
- Im Leistungspreis enthalten: Modellgips (Hartgips), Superhartgips (Modellmaterial), Trennmittel, Polier- und Fräskörper
