...
| 2983 | Titan verarbeiten bei fest sitzendem Zahnersatz | 1 | je Einheit; Zuschlag für die Titanbearbeitung des Abutments |
...
- Entweder Komplettposition ODER Gerüstkette: kalkuliert ist 0917 + 2823 + 2832 + 2863 + 2612; Alternativen sind 2810 (vollständig verblendet) und 2160 (Scan + Konstruktion in einem); 2616 alternativ zu 2612; 2955 Glasieren ist in 2612/2616 enthalten und nur monolithisch ansetzbar
- Abutment-Weichen: individuell CAD-CAM-gefräst → 0887 + 2823 + 2983; gegossen über Kunststoff-Ausbrennpfosten → 2031 (statt 0887 + 2823); konfektioniert → 2973. Nie kumulativ
- Abgrenzungen: 2823 je gefräster Einheit (Abutment + Krone), 2832 nur je Kroneneinheit; 2972 deckt den Fertigungsmehraufwand der verschraubten Suprakonstruktion, 3905 nur die laborseitig eingearbeitete Gewindehülse; 0240 nur bei laborgefertigter Kappe (konfektionierte Transferkappe = Material); 2840 alternativ zu 2965; 0031/0032/0856 stehen statt 0018/0002 bei rein digitalem Workflow
...
- VERIFIZIEREN: ob Krone und Titan-Abutment einteilig gefräst (dann kein Klebekomposit, 1550/5306 entfallen) oder zweiteilig verklebt werden; ob 3905 im Haus für den CAD-konstruierten Schraubenkanal angesetzt wird; Auslegung von 2823 „je CAD/CAM-Einheit". Im Leistungspreis enthalten: Verblendkeramik (Schichtmassen), Malfarben/Glasurmasse, Sintermasse/Sinterhilfsmittel (Sinterperlen/-schale), Klebekomposit (Composite-Cement), MDP-Primer, Abstrahlmittel (Aluminiumoxid/Rocatec), Modellgips (Superhartgips), Silikon der Gingivamaske, Einbettmasse
