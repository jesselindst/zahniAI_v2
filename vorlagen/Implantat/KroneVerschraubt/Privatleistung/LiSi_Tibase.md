...
| 0817 | Implantatabutment-Auswahl | 1 | je Implantat; Auswahl der TiBase/Klebebasis |
...
| 0887 | CAD/CAM Konstruktion individuelles Abutment | 1 | je Mesostruktur (LiSi auf TiBase) |
...
| 2823 | CAD/CAM-Fräsen/-Schleifen einer CAD/CAM-Einheit | 2 | je gefräster Einheit: Mesostruktur + Krone; bei einteiliger Hybridabutmentkrone 1 |
| 2832 | CAD/CAM Krone/Brückenglied nacharbeiten | 1 | je Kroneneinheit; Nacharbeit der Mesostruktur ist mit 2165 abgegolten |
...
| 1550 | Konditionierung je Zahn/Flügel | 1 | je Klebestelle Mesostruktur ↔ TiBase; alternativ zu 5306 |
...
| 0953 | Zahnfarbenbestimmung – Stumpffarbe (III/IV) | 1 | bei dunkler Klebebasis (Maskierung) |
...
|--------|--------|--------|
| TiBase/Klebebasis | 1 Stück | gesondert: Einkaufspreis zzgl. Beleg; Schnittstelle Mesostruktur ↔ Implantat |
| LiSi-Block (CAD-CAM, z. B. IPS e.max CAD) | 2 Stück | je gefräster Einheit (Mesostruktur + Krone), einteilig 1 Stück; gesondert: Einkaufspreis zzgl. Beleg |
...
- Komplett privat (BEB/GOZ), kein Festzuschuss; Privatleistung nur bei PKV, ohne HKP oder bei ausdrücklichem Komplett-Privatwunsch. → Vorlage ../andersartig/LiSi_Tibase bei GKV-Versichertem mit HKP (Festzuschuss der Ausgangssituation vor Implantation, 2.1 + 2.7, bleibt erhalten)
- VERIFIZIEREN: ob das Labor LiSi-Mesostrukturen auf TiBase fertigt (Katalogtext zu 2165 nennt Zirkon-Abutments auf Titanbasis) und über welche Position der Kristallisationsbrand läuft (2863 nennt „Sintern"; sonst Zeiteinheit 0721/0722); ob 3905 für den CAD-konstruierten Schraubenkanal angesetzt wird; Auslegung von 2823 „je CAD/CAM-Einheit" im Hauskatalog
- Im Leistungspreis enthalten: Verblendkeramik (Schichtmassen), Malfarben/Glasurmasse, Kristallisations-/Sintermasse und Sinterhilfsmittel (Brennwatte/Brennpaste), Klebekomposit (Composite-Cement), Flusssäure-Ätzgel/Silan, Abstrahlmittel (Aluminiumoxid), Modellgips (Superhartgips), Silikon der Gingivamaske, Einbettmasse
