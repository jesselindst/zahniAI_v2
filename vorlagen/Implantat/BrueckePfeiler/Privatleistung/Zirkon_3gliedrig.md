...
|--------|--------|--------|--------|
| Implantatversorgung / Brücke (Implantat-Pfeiler) / Privatleistung | CLAUDE | 2026-04-27 | v1 |
...
| 2612 | Mehrflächige Verblendung aus Keramik | 3 | je Element vollverblendet |
...
3-gliedrige Implantatbrücke aus Zirkon, CAD-CAM gefräst, vollverblendet — reine Privatleistung. PKV-Patient oder GKV-Patient mit reiner Privatzahlung (ohne HKP-Antrag, kein Festzuschuss). Komplettabrechnung BEB97 + GOZ. Vorlage gilt für verschraubte Variante (mit Schraubenkanal in den Pfeilerkronen).