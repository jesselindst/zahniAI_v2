...
| 0918 | CAD/CAM Konstruktionsgrenze festlegen | 3 | 2 Anker + 1 Brückenglied |
| 0917 | Konstruktion CAD-Krone zur Verblendung | 3 |  |
| 2810 | CAD/CAM-Krone, vollständig verblendet | 2 | je Pfeiler |
| 2815 | CAD/CAM-Brückenglied, vollständig verblendet | 1 | Zwischenglied |
...
| 2612 | Mehrflächige Verblendung aus Keramik | 3 | je Glied vollverblendet |
| 2972 | Aufwand zu Suprastruktur bei verschraubbarem Implantat | 2 | je Implantatpfeiler |
...
| 1869 | Provisorische Krone/Brückenglied auf Implantat | 3 | bei provisorischer Versorgung |
| 1351 | Vorwall und Zähne nach Einprobe über Implantat anpassen | 1 | nach Einprobe-Korrektur |
| 1550 | Konditionierung je Zahn/Flügel | 3 | bei Bedarf |
...
| 2952 | Zuschlag bei Verarbeitung von Spezialkeramik | 3 | bei Sonderkeramik |
| 2959 | Mehraufwand durch Rohbrandeinprobe | 1 | bei Bedarf |
| 2951 | Individuell charakterisieren, Keramik | 3 | bei Sonderfarbung |
| 2963 | Mehrere Farben in Kronen- oder Brückenverband | 1 | bei mehreren Farben |
| 2675 | Schulter aus Keramik/Glas | 3 | bei Pontic-Schultergestaltung |
| 2676 | Papille aus Keramik/Glas | 1 | bei ästhetischer Papillenformung am Brückenglied |
| 2677 | Zahnfleisch aus Keramik/Glas | 3 | bei Zahnfleisch-Keramik am Pontic/Pfeiler |
| 2678 | Wurzelpontic aus Keramik/Glas | 1 | bei Wurzelpontic-Design (Brückenglied) |
| 2679 | Sattelpontic aus Keramik/Glas | 1 | bei Sattelpontic-Design (Brückenglied) |
| 2802 | Kaufläche gnathologisch gestaltet, in Keramik | 3 | bei gnathologischer Kauflächengestaltung |
| 2804 | Frontzahn gnathologisch gestaltet, in Keramik | 3 | bei gnathologischer Frontzahngestaltung |
...
| 3628 | Fertigstellen je Zahneinheit bei Implantatversorgung | 3 | bei Bedarf |
...
|--------|--------|--------|
| Titan-Rohling (für individuelle Abutments) | 2 Stück | je Implantatpfeiler |
| CAD/CAM Block Zirkon | 1 Stück | für 3-gliedriges Brückengerüst |
| Verblendkeramik | — | Schichtkeramik vollverblendet (3 Glieder) |
| Verschraubung (konfektioniert) | 2 Stück | je Implantat |
| Modellgips (Superhartgips) | — |  |
| Modellanalog | 2 Stück | je Implantat |
| Gingivamaske (Silikon) | — |  |
| Sintermasse / Sinterhilfsmittel | — |  |

# Hinweise

3-gliedrige Implantatbrücke aus Zirkon, CAD-CAM gefräst, vollverblendet — andersartige Versorgung (Standardfall Implantat). 2 Implantatpfeiler tragen die Brücke; 1 Brückenglied ersetzt einen fehlenden Zahn dazwischen (Befund 2.1 zahnbegrenzte Lücke mit einem fehlenden Zahn). Patient erhält Festzuschuss in Höhe der hypothetischen Brücken-Regelversorgung; Implantatchirurgie und Suprakonstruktion komplett privat (BEB97 + GOZ). Vorlage gilt für verschraubte Variante (mit Schraubenkanal in den Pfeilerkronen). HKP-Antrag erforderlich für Festzuschuss.